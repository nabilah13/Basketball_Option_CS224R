...
class BasketballDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        reward = torch.max(torch.tensor(current_row["CumulativePlayerPointsInterval"] - 
                              current_row["RollingAvgPlayerPointsInterval"]), torch.tensor(0))
        ...
        return state, reward, next_state, terminal, gameId, player
